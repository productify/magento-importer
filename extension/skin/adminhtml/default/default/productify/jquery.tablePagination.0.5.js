 ...
 (function($){
    ...
    var defaults = {  
//			firstArrow : (new Image()).src="first.gif",
			firstArrow : (new Image()).src="../../../skin/adminhtml/default/default/productify/first.gif",
			prevArrow : (new Image()).src="../../../skin/adminhtml/default/default/productify/prev.gif",
			lastArrow : (new Image()).src="../../../skin/adminhtml/default/default/productify/last.gif",
			nextArrow : (new Image()).src="../../../skin/adminhtml/default/default/productify/next.gif",
			rowsPerPage : 10,
			currPage : 1,
			optionsForRows : [10,25,50,100,250,500,750,1000,2000,3000,4000,5000,10000],
			ignoreRows : [],
			topNav : false
		};  
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<input id='tablePagination_currPage' type='input' readonly value='"+currPageNumber+"' size='1'>");
